...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* {This div tag contains the "hero section" of the landing page; it's the first thing that users see.} */}
      <div className=''>
        ...
        <div className=''>
          <div className='flex bg-black space-x-16 py-16 px-16 items-center'>
            ...
            {/* {The main text and two buttons: "Login" and "Create an Account."} */}
            <div className=''>
          ...
          </div>
          {
            /* {
              ...
              TODO: The Instagram Posts should become the same size.
            } */
          }
          <div className="px-16">
